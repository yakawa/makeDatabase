...
const (
	...
	_Type_name_3 = "K_ALLK_ANDK_ASK_ASCK_BETWEENK_BYK_CASEK_CASTK_COLLATEK_CROSSK_CURRENTK_CURRENT_DATEK_CURRENT_TIMEK_CURRENT_TIMESTAMPK_DESCK_DISTINCTK_ELSEK_ENDK_EXCLUDEK_ESCAPEK_EXCEPTK_EXISTSK_FALSEK_FILTERK_FIRSTK_FOLLOWINGK_FROMK_GLOBK_GROUPK_GROUPSK_HAVINGK_INTERSECTK_INK_INDEXEDK_INNERK_ISK_ISNULLK_JOINK_LASTK_LEFTK_LIKEK_LIMITK_MATCHK_NATURALK_NOK_NOTK_NOTNULLK_NULLK_NULLSK_OFFSETK_ONK_ORK_ORDERK_OTHERSK_OUTERK_OVERK_PARTITIONK_PRECEDINGK_RANGEK_RECURSIVEK_REGEXPK_RIGHTK_ROWK_ROWSK_SELECTK_THENK_TIESK_TRUEK_UNBOUNDEDK_UNIONK_USINGK_VALUESK_WHENK_WHEREK_WINDOWK_WITH"
)
